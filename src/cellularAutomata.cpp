...
ruleAutomata::ruleAutomata(std::initializer_list<uint8_t> birth, std::initializer_list<uint8_t> survival, vec2 gridSize, std::deque<std::deque<uint8_t>> grid): birth(birth), survival(survival), size(gridSize), grid(grid) {
